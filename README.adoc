...
8. Third step, _Configure the service_, create the domain resource that will allow to send requests, from the public Internet to the application.
+
...
** For example:
+
image::./doc/images/axebow-run-service-step03.png[]
+
WIP

9. Last step, _Connect your service_, create a public port, accesible from the Internet and link it to the port the container listens and the application attend the HTTPS requests.
